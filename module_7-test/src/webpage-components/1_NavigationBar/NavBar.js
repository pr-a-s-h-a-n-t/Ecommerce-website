    ...
    <>
      <div className="header-container">
        ...
        {/* {name ? <li onClick={( ) => {
          ...
          { name  ? <li className="login">
             <span   > <img style={styles.login.img} src={profilePhoto} /> </span>
            <span 
            onClick={( ) => {
              localStorage.clear();
              window.location.reload()
            ...
            className="login-text">LogOut</span>
          </li>
           :
